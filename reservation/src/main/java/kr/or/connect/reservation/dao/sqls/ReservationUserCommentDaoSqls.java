...
public class ReservationUserCommentDaoSqls {
	...
	public static final String SELECT_USER_COMMENT = "select ruc.id as id, ruc.product_id as product_id, ri.id as reservation_info_id,\r\n"
			+ "ruc.score as score,u.email as reservation_email , ruc.comment as comment,u.id as user_id, ruc.create_date as create_date, ruc.modify_date as modify_date\r\n"
	...
	public static final String ORDER_LIMIT="order by ruc.id desc limit :start,:limit";
